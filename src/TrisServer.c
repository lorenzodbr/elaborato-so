...
int main(int argc, char *argv[])
{
    ...
    {
        errExit("I simboli dei giocatori devono essere di un solo carattere.");
    }
...
void playerQuitHandler(int sig)
{
    ...
    printf("\nIl giocatore %d (con PID = %d) ha abbandonato la partita.", playerWhoQuitted, pids[playerWhoQuitted]);
